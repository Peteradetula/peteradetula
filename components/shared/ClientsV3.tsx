...
// Data-----------------
const topContent = ['Product Management', 'Product Design', 'Product Management', 'Product Design']
const bottomContent = ['UX Engineer', 'Based in London', 'AI Enthusiast', 'UX Engineer', 'Based in London']
