        ...
        <div className="mb-8 text-center md:mb-14">
          ...
          <TextAppearAnimation>
            <h2 className="text-appear my-3 max-sm:text-[28px]">
              Cinematic excellence that
              <br />
              <i className="font-instrument">sets us apart</i>
            </h2>
          </TextAppearAnimation>
          <TextAppearAnimation>
        ...
        <article>
          <RevealWrapper className="reveal-me mb-[30px] flex flex-col gap-[30px] max-lg:flex-wrap md:flex-row">
            <div className="flex-1 border px-[30px] py-10 dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5">Award-Winning productions</h5>
              <p>Recognized globally for innovative filmmaking.</p>
            </div>
            <div className="flex-1 border px-[30px] py-10 dark:border-dark">
              <span>
              ...
              <h5 className="mb-2.5 mt-5">Industry-Leading talent</h5>
              <p>Collaborating with the best directors, producers, and creatives.</p>
            </div>
            <div className="flex-1 border px-[30px] py-10 dark:border-dark">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width={61} height={60} viewBox="0 0 61 60" fill="none">
              ...
              <h5 className="mb-2.5 mt-5">State-of-the-Art technology</h5>
              <p>4K/8K production, high-end VFX, and next-gen post-production.</p>
            </div>
          </RevealWrapper>
          <RevealWrapper className="reveal-me flex flex-col gap-[30px] md:flex-row">
            <RevealWrapper className="reveal-me min-h-[322px] flex-1 border px-[30px] py-20 dark:border-dark">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width={60} height={60} viewBox="0 0 60 60" fill="none">
                  <rect width={60} height={60} className="fill-backgroundBody dark:fill-secondary" />
                  <path
              ...
              <h5 className="mb-2.5 mt-5">Global reach, Local expertise</h5>
              <p>Bringing visionary projects to life worldwide.</p>
            </RevealWrapper>
            ...
            <RevealWrapper className="reveal-me min-h-[322px] flex-1 border px-[30px] py-20 dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5">Creative collaboration</h5>
              <p>Your vision, transformed into a cinematic masterpiece.</p>
            </RevealWrapper>
          </RevealWrapper>
        </article>

        <RevealWrapper className="reveal-me mt-8 flex justify-center md:mt-16">
          <div className="mx-auto block max-md:w-full md:ml-auto md:inline-block md:w-auto">
            <Link href="/contact" className="rv-button rv-button-white block text-center md:inline-block">
