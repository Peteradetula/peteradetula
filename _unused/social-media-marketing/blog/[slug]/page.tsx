import { Blog2Type } from '@/_unused/seo-blog/page'
...
export async function generateStaticParams() {
  const blogs: Blog2Type[] = getMarkDownData('data/social-media-marketing/blog')
...
const BlogDetails = async ({ params }: { params: Promise<{ slug: string }> }) => {
  ...
  const blog = getMarkDownContent('data/social-media-marketing/blog/', slug)
