...
const travelServices: MarkdownData[] = getMarkDownData('data/travel-agency/services').sort(
  //@ts-ignore
  (a, b) => a.serialNumber - b.serialNumber,
)

const sliceOne = travelServices.slice(0, 3)
const sliceTwo = travelServices.slice(3, 6)
          ...
          <div className="flex-1 md:self-start">
            <TextAppearAnimation>
              <h2 className="text-appear lg:leading-[1.20]">
                Seamless planning,
                <i className="font-instrument">exceptional experiences</i>
              </h2>
            </TextAppearAnimation>
          </div>
          ...
          <RevealWrapper
            ...
            <div>
              ...
              <div className="absolute z-10 h-full w-full flex-1 translate-y-full bg-secondary px-[30px] py-12 transition-all duration-700 group-hover:inset-0 group-hover:translate-y-0 dark:bg-backgroundBody">
                ...
                <Link
                  href={`/travel-agency/services/${service.slug}`}
