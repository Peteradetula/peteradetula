        ...
        <div className="mb-10 md:mb-20">
          <TextAppearAnimation>
            <h2 className="text-appear text-center">
              What our <span className="font-instrument italic"> clients say</span>
            </h2>
          </TextAppearAnimation>
          <TextAppearAnimation>
            <p className="text-appear mx-auto mt-1.5 max-w-xl text-center md:mt-6 lg:max-w-3xl">
              I have been using this service for over a year, and it has significantly improved my workflow. Highly
