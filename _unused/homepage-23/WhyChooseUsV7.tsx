...
const WhyChooseUsV7 = () => {
  return (
    <section className="pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[200px]">
      <div className="container">
        <div className="mx-auto mb-10 max-w-3xl text-center md:mb-16">
          ...
          <TextAppearAnimation>
            <h2 className="text-appear lg:leading-[1.1]">
              Excellence in every
              <span className="font-instrument italic"> detail </span>
            </h2>
          </TextAppearAnimation>
          <TextAppearAnimation>
        ...
        <RevealWrapper className="reveal-me grid grid-cols-12 gap-[30px]">
          <div className="col-span-12 flex-1 border px-[30px] py-10 dark:border-dark lg:col-span-6">
            ...
            <h5 className="mb-2.5 mt-5">Years of industry expertise</h5>
            <p className="text-base font-normal leading-[25.6px] text-black/70 dark:text-backgroundBody/70">
              Trusted advisors with [X+] years in the insurance sector.
            </p>
          </div>
          <div className="col-span-12 flex-1 border px-[30px] py-10 dark:border-dark lg:col-span-6">
            <span>
            ...
            <h5 className="mb-2.5 mt-5">Personalized approach</h5>
            <p className="text-base font-normal leading-[25.6px] text-black/70 dark:text-backgroundBody/70">
              Policies crafted to meet your unique needs.
            </p>
          </div>
          <div className="col-span-12 flex-1 border px-[30px] py-10 dark:border-dark lg:col-span-6">
            <span>
            ...
            <h5 className="mb-2.5 mt-5">Hassle free process</h5>
            <p className="text-base font-normal leading-[25.6px] text-black/70 dark:text-backgroundBody/70">
              Seamless claims handling &amp; expert assistance.
            </p>
          </div>
          <div className="col-span-12 flex-1 border px-[30px] py-10 dark:border-dark lg:col-span-6">
            <span>
            ...
            <h5 className="mb-2.5 mt-5">24/7 client suppor</h5>
            <p className="text-base font-normal leading-[25.6px] text-black/70 dark:text-backgroundBody/70">
              Always available for any insurance-related queries.
            </p>
          </div>
        </RevealWrapper>
