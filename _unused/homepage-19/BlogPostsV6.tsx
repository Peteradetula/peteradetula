...
const loadedBlogs: BlogsType[] = getMarkDownData('data/startup-agency/blog')
        ...
        <div className="flex items-start justify-center overflow-hidden max-lg:flex-wrap max-lg:gap-y-5 md:space-x-[30px]">
          {blogPosts.map((blog) => (
            <div
              ...
              <Link href={`/startup-agency/blog/${blog?.slug}`} className="w-full">
              ...
              <div className="px-2.5">
                ...
                <div className="absolute bottom-[22px]">
                  <Link href={`/startup-agency/blog/${blog?.slug}`} className="w-full"></Link>
                  <Link
                    href={`/startup-agency/blog/${blog?.slug}`}
