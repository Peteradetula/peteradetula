    ...
    <section className="overflow-hidden pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[100px]">
        ...
        <div className="mb-7 text-center lg:mb-14">
          ...
          <TextAppearAnimation>
            <h2 className="text-appear mb-3 text-center">
              Tailored plans for startups of
              <br className="hidden md:block" />
              <i className="font-instrument"> all sizes </i>
            </h2>
          </TextAppearAnimation>
          <TextAppearAnimation>
            <p className="text-appear mx-auto max-w-3xl">
              Transparent pricing for every stage of growth. Choose a package that fits your business needs and budget.
            </p>
          </TextAppearAnimation>
        </div>
      </div>
      ...
      <div className="mx-auto flex max-w-[1600px] items-center justify-center gap-[30px] max-2xl:flex-wrap max-sm:px-5">
        {pricingPlans.map((plan) => {
          const { title, price, features, ctaText = 'Get Started', ctaVariant = 'white', isFeatured, id } = plan
            ...
            <RevealWrapper
              ...
              {isFeatured && (
                <div
                  ...
                  style={{ backgroundImage: `url(${isFeatured.src})` }}></div>
              )}
