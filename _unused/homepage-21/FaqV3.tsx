'use client'
import faqV3Data from '@/data/faqV3.json'
...
const FaqV3 = ({ bigTitleWithBadge = false }: FaqProps) => {
        ...
        {bigTitleWithBadge ? (
          <>
            <div className="text-center">
              <RevealWrapper className="rv-badge reveal-me mb-4 lg:mb-6">
