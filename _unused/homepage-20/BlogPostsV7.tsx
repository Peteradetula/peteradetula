...
const loadedBlogs: BlogsType[] = getMarkDownData('data/social-media-marketing/blog')
        ...
        <div className="flex items-start justify-center overflow-hidden max-lg:flex-wrap max-lg:gap-y-5 md:space-x-[30px]">
          {blogPosts.map((blog) => (
            <div
              ...
              <Link href={`/social-media-marketing/blog/${blog?.slug}`} className="w-full">
              ...
              <div className="px-2.5">
                ...
                <div className="absolute bottom-[22px]">
                  <Link href={`/social-media-marketing/blog/${blog?.slug}`} className="w-full"></Link>
                  <Link
                    href={`/social-media-marketing/blog/${blog?.slug}`}
